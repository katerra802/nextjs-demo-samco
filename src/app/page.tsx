...
function HomePage({ language = 'vi' }: LanguageProps) {
  ...
  const slider1_Data = [
    ...
    { title: 'LIMO GREEN', subtitle: '', decorativeText: 'LIMO GREEN', image: '/anhxe/xe1.png', backgroundImage: '#f8f9fa', stats: [{ label: 'Dòng xe', value: 'MPV' }, { label: 'Số chỗ ngồi', value: '7 chỗ' }, { label: 'Quãng đường lên tới', value: '450 km (NEDC)' }, { label: 'Giá từ', value: '749.000.000 VNĐ' }], actions: [{ text: 'ĐẶT CỌC', href: '/dat-coc/limo-green', variant: 'primary' }, { text: 'XEM CHI TIẾT', href: '/cars/herio-green', variant: 'secondary' }] },
    { title: 'NERIO GREEN', subtitle: '', decorativeText: 'NERIO GREEN', image: '/anhxe/xe2.png', backgroundImage: '#f8f9fa', stats: [{ label: 'Dòng xe', value: 'B-SUV' }, { label: 'Số chỗ ngồi', value: '5 chỗ' }, { label: 'Quãng đường lên tới', value: '318.6 km (NEDC)' }, { label: 'Giá từ', value: '668.000.000 VNĐ' }], actions: [{ text: 'ĐẶT CỌC', href: '/dat-coc/nerio-green', variant: 'primary' }, { text: 'XEM CHI TIẾT', href: '/cars/herio-green', variant: 'secondary' }] },
    { title: 'HERO RED', subtitle: '', decorativeText: 'HERO RED', image: '/anhxe/xe3.png', backgroundImage: '#f8f9fa', stats: [{ label: 'Dòng xe', value: 'C-SUV' }, { label: 'Số chỗ ngồi', value: '5 chỗ' }, { label: 'Quãng đường lên tới', value: '510 km (NEDC)' }, { label: 'Giá từ', value: '899.000.000 VNĐ' }], actions: [{ text: 'ĐẶT CỌC', href: '/dat-coc/hero-red', variant: 'primary' }, { text: 'XEM CHI TIẾT', href: '/cars/herio-green', variant: 'secondary' }] },
  ];
  const newsArticles = [
  ...
  // <<< THAY ĐỔI 2: TẠO RA DỮ LIỆU ĐỘNG DỰA TRÊN STATE >>>
  const activeCarData = limoGreenStyleData[activeCarIndex];
  // =================================================================
  ...
  return (
    <div>
      {/* SLIDER 1: Vẫn giữ nguyên vì logic của nó đơn giản */}
      <HeroSlider slides={slider1_Data} className="relative w-full h-screen" autoSlide arrowStyle='dark' size="screen">
        {(activeSlide: any) => (
            <>
      ...
      {/* SECTION CHO SLIDER 2 & 3 - ĐÃ ĐƯỢC LÀM ĐỘNG */}
        {/* <<< THAY ĐỔI 3: TRUYỀN STATE VÀO SLIDER >>> */}
        <HeroSlider
          slides={limoGreenStyleData}
          className="relative w-full h-[60vh] md:h-[70vh]" 
          activeIndex={activeCarIndex}
          onSlideChange={setActiveCarIndex}
          arrowStyle='dark'
        >
            {(activeSlide) => (
            <div className="w-full h-full">
              {/* Ảnh nền của slide */}
                ...
                {/* Tên xe */}
                <div className="absolute inset-0 z-10 flex  justify-center pointer-events-none -translate-y-10 -translate-x-10"> 
        ...
        {/* <<< THAY ĐỔI 4: DÙNG DỮ LIỆU ĐỘNG ĐỂ HIỂN THỊ THÔNG TIN >>> */}
        <div className="max-w-10xl mx-auto px-4 p-8 -mt-16 relative z-30 bg-white ">
            {activeCarData.stats && <InfoGrid items={activeCarData.stats} className="mb-8" />}
            {activeCarData.actions && <ActionPanel actions={activeCarData.actions} />}
        </div>
